...
###############################################################################
# setup-defaults.sh — macOS system preferences
# Can be re-run safely at any time.
# Uncomment any setting below to enable it on next run.
###############################################################################
...
# Show the full URL in the address bar (note: still hides the scheme)
...
# Don't prompt to use new drives as backup volume
...
# Check daily, download in background, install security updates
...
# Disable smart quotes (annoying for messages containing code)
...
###############################################################################
for app in "Activity Monitor" "Dock" "Finder" "Mail" "Messages" "Photos" "Safari" "SystemUIServer"; do
